...
type AvatarStore interface {
	CreateWithOutbox(ctx context.Context, a *domain.Avatar, ev domain.OutboxEvent) (int64, error)
	...
	SoftDeleteOwnedWithOutbox(ctx context.Context, id uuid.UUID, userID string, ev domain.OutboxEvent) (*domain.Avatar, int64, error)
